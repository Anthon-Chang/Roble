...
const services = [
  {
    icon: <GrUserWorker className="text-6xl text-amber-700 dark:text-amber-400" />,
  ...
  {
    icon: <IoIosPeople className="text-6xl text-amber-700 dark:text-amber-400" />,
    title: "Gestión de Clientes",
    description:
      "Podrás ver y gestionar los productos asociados a cada profesional y solicitar contacto personal fácilmente."
  },
  {
    icon: <SiMaterialformkdocs className="text-6xl text-amber-700 dark:text-amber-400" />,
    title: "Gestión de Materiales",
    description:
      "Acuerdos mutuos con nuestros profesionales para escoger los mejores materiales para tus muebles según cada caso."
  },
  {
    icon: <IoChatbubbleEllipsesSharp className="text-6xl text-amber-700 dark:text-amber-400" />,
...
const Servicios = () => {
  return (
    <section id="servicios" className="container mx-auto px-4 py-12">
      <h2 className="text-3xl font-semibold text-center mb-12 text-gray-900 dark:text-gray-100 relative inline-block py-10">
        SERVICIOS
      ...
      <div className="flex flex-col gap-6">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-700 hover:shadow-lg transition-shadow duration-300 rounded-lg p-6 flex items-start gap-4"
          >

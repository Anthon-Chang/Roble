    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <h2 className="text-xl font-semibold text-gray-700 mb-3">Agendar entrevista</h2>
          <hr className="mb-4" />
          ...
          <form className="space-y-3">
            ...
            <div>
              <label htmlFor="mascota" className="text-sm text-gray-600">Producto</label>
              <input id="mascota" className={inputCls} placeholder="Tipo de mueble" />
            </div>
            ...
            <div>
              ...
              <input id="motivo" className={inputCls} placeholder="Negocio, Hogar, etc." />
            </div>
          ...
          <ul className="divide-y">
            <li className="py-3 flex justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Cliente: Luna</p>
                <p className="text-sm text-gray-600">Producto: Closet</p>
                <p className="text-sm text-gray-600">Motivo:  mueblenuevo para el hogar</p>
              </div>

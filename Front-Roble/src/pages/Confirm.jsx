...
import FConfirm from '../assets/confirm.png'
   ...
   const fetchDataBackend = useFetch()
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <img className="object-cover h-80 w-80 border-solid border-slate-600" src={FConfirm} alt="image description"/>

            <div className="flex flex-col items-center justify-center">
                <p className="text-3xl md:text-4xl lg:text-5xl mt-12">Muchas Gracias</p>
